...
class Bottle {
  ...
  init() {
    ...
    var texture = this.loader.load('/game/images/head.png');
    ...
    var texture2 = this.loader.load('/game/images/bottom.png');
    ...
    var middleGeometry = new THREE.CylinderGeometry(
      headRadius,
      0.88 * headRadius,
      1.2 * headRadius,
      20
    );
    var texture3 = this.loader.load('/game/images/top.png');
    ...
    utils.merge(totalGeometry, middleGeometry, 0, [
      { x: 0, y: this.bottom.position.y + 1.94 * headRadius, z: 0 },
    ]);
    var topGeometry = new THREE.SphereGeometry(headRadius, 20, 20);
    topGeometry.scale(1, 0.54, 1);
    utils.merge(totalGeometry, topGeometry, 1, [
      { x: 0, y: this.bottom.position.y + 2.54 * headRadius, z: 0 },
    ]);
