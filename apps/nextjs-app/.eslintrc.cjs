...
require('@bid-np/eslint-config-bases/patch/modern-module-resolution');
...
module.exports = {
  ...
  extends: [
    ...
    '@bid-np/eslint-config-bases/react',
    '@bid-np/eslint-config-bases/tailwind',
    '@bid-np/eslint-config-bases/rtl',
