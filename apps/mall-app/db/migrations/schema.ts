...
export const mmallCategory = mysqlTable("mmall_category", {
...
export const mmallOrder = mysqlTable("mmall_order", {
	id: bigint("id", { mode: "number" }).autoincrement().notNull(),
...
export const mmallOrderItem = mysqlTable("mmall_order_item", {
	id: int("id").autoincrement().notNull(),
	userId: int("userId"),
	orderNo: bigint("orderNo", { mode: "number" }),
	productId: int("productId"),
...
(table) => {
	return {
		idIdxOrderNo: index("mmall_order_item_id__idx__order_no").on(table.id, table.orderNo),
		mmallOrderItemIdUnique: unique("mmall_order_item_id__unique").on(table.id),
	}
});

export const mmallPayInfo = mysqlTable("mmall_pay_info", {
	id: bigint("id", { mode: "number" }).autoincrement().notNull(),
	userId: int("userId"),
	orderNo: bigint("orderNo", { mode: "number" }),
...
export const mmallProduct = mysqlTable("mmall_product", {
	id: bigint("id", { mode: "number" }).autoincrement().notNull(),
...
export const mmallShipping = mysqlTable("mmall_shipping", {
	id: bigint("id", { mode: "number" }).autoincrement().notNull(),
	userId: int("userId"),
...
export const mmallUser = mysqlTable("mmall_user", {
	id: bigint("id", { mode: "number" }).autoincrement().notNull(),
